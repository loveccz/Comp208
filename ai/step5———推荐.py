...
def creat_user_cluster(cluster_num):
    file = "D:\\桌面\\comp208\\Recommend_By_Canopy-K-means-main\\Recommend_By_Canopy-K-means-main\\测试4_K近邻=30\\train\\user_Cluster_T1=100,T2=100.xls"
...
def creat_user_movie_dic(cluster):
    dic={}
    file = "D:\\桌面\\comp208\\Recommend_By_Canopy-K-means-main\\Recommend_By_Canopy-K-means-main\\测试4_K近邻=30\\train\\实验数据_clear.csv"
...
if __name__ == '__main__':
    ...
    for i in range(1,183,1):#用户id
        ...
        outfile="D:\\桌面\\comp208\\Recommend_By_Canopy-K-means-main\\Recommend_By_Canopy-K-means-main\\40\\user_{}".format(i)
