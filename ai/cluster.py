...
center_points = []
K = 0
file="D:\\桌面\\comp208\\Recommend_By_Canopy-K-means-main\\Recommend_By_Canopy-K-means-main\\pca_point3.csv"
...
canopy = Canopy.Canopy(points, t1=40, t2=40)#设定T1和T2，Canopy聚类,T1>T2
...
data2 = np.array(kmeans_cluster,dtype=object)  # np.ndarray()每个姓名转换为一个list[]
# print(train_data)
